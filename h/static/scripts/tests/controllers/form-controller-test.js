...
function fieldTemplate(field) {
  ...
  return `<div class="js-form-input" data-ref="${field.fieldRef}" ${hideAttr}>
    <input id="deformField" data-ref="formInput ${field.ref}" value="${field.value}">
  </div>`;
}
...
describe('FormController', function () {
  ...
  context('when the form is a "Change Email"-type form', function () {
    beforeEach(function () {
      ...
      // has one field that begins editing plus a set of hidden fields which
      // are all shown once the user starts editing the form
